...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "LOOP_ITER_W" -parent ${Page_0}
...
proc update_PARAM_VALUE.LOOP_ITER_W { PARAM_VALUE.LOOP_ITER_W } {
	# Procedure called to update LOOP_ITER_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LOOP_ITER_W { PARAM_VALUE.LOOP_ITER_W } {
	# Procedure called to validate LOOP_ITER_W
	return true
}
...
proc update_MODELPARAM_VALUE.LOOP_ITER_W { MODELPARAM_VALUE.LOOP_ITER_W PARAM_VALUE.LOOP_ITER_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.LOOP_ITER_W}] ${MODELPARAM_VALUE.LOOP_ITER_W}
}
