...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BBUF_DATA_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "IBUF_DATA_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "OBUF_DATA_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "WBUF_DATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "WBUF_WSTRB_W" -parent ${Page_0}
  ipgui::add_param $IPINST -name "WEIGHT_ROW_NUM" -parent ${Page_0}

  #Adding Page
  set page1 [ipgui::add_page $IPINST -name "page1"]
  ipgui::add_param $IPINST -name "IMEM_ILA_EN" -parent ${page1}
...
proc update_PARAM_VALUE.BBUF_DATA_WIDTH { PARAM_VALUE.BBUF_DATA_WIDTH } {
	# Procedure called to update BBUF_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BBUF_DATA_WIDTH { PARAM_VALUE.BBUF_DATA_WIDTH } {
	# Procedure called to validate BBUF_DATA_WIDTH
	return true
}
...
proc update_PARAM_VALUE.IBUF_DATA_WIDTH { PARAM_VALUE.IBUF_DATA_WIDTH } {
	# Procedure called to update IBUF_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IBUF_DATA_WIDTH { PARAM_VALUE.IBUF_DATA_WIDTH } {
	# Procedure called to validate IBUF_DATA_WIDTH
	return true
}
...
proc update_PARAM_VALUE.IMEM_ILA_EN { PARAM_VALUE.IMEM_ILA_EN } {
	# Procedure called to update IMEM_ILA_EN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IMEM_ILA_EN { PARAM_VALUE.IMEM_ILA_EN } {
	# Procedure called to validate IMEM_ILA_EN
	return true
}
...
proc update_PARAM_VALUE.OBUF_DATA_WIDTH { PARAM_VALUE.OBUF_DATA_WIDTH } {
	# Procedure called to update OBUF_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.OBUF_DATA_WIDTH { PARAM_VALUE.OBUF_DATA_WIDTH } {
	# Procedure called to validate OBUF_DATA_WIDTH
	return true
}
...
proc update_PARAM_VALUE.WBUF_DATA_WIDTH { PARAM_VALUE.WBUF_DATA_WIDTH } {
	# Procedure called to update WBUF_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.WBUF_DATA_WIDTH { PARAM_VALUE.WBUF_DATA_WIDTH } {
	# Procedure called to validate WBUF_DATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.IMEM_ILA_EN { MODELPARAM_VALUE.IMEM_ILA_EN PARAM_VALUE.IMEM_ILA_EN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IMEM_ILA_EN}] ${MODELPARAM_VALUE.IMEM_ILA_EN}
}
...
proc update_MODELPARAM_VALUE.WBUF_DATA_WIDTH { MODELPARAM_VALUE.WBUF_DATA_WIDTH PARAM_VALUE.WBUF_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.WBUF_DATA_WIDTH}] ${MODELPARAM_VALUE.WBUF_DATA_WIDTH}
}

proc update_MODELPARAM_VALUE.BBUF_DATA_WIDTH { MODELPARAM_VALUE.BBUF_DATA_WIDTH PARAM_VALUE.BBUF_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BBUF_DATA_WIDTH}] ${MODELPARAM_VALUE.BBUF_DATA_WIDTH}
}

proc update_MODELPARAM_VALUE.IBUF_DATA_WIDTH { MODELPARAM_VALUE.IBUF_DATA_WIDTH PARAM_VALUE.IBUF_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IBUF_DATA_WIDTH}] ${MODELPARAM_VALUE.IBUF_DATA_WIDTH}
}

proc update_MODELPARAM_VALUE.OBUF_DATA_WIDTH { MODELPARAM_VALUE.OBUF_DATA_WIDTH PARAM_VALUE.OBUF_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.OBUF_DATA_WIDTH}] ${MODELPARAM_VALUE.OBUF_DATA_WIDTH}
}
