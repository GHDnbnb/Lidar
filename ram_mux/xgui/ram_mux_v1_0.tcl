...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ARRAY_N_WBUF" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "TAG_BUF_ADDR_W_BBUF" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TAG_BUF_ADDR_W_IBUF" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TAG_BUF_ADDR_W_OBUF" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TAG_BUF_ADDR_W_WBUF" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TAG_W" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "WEIGHT_ROW_NUM" -parent ${Page_0}
...
proc update_PARAM_VALUE.ARRAY_N_WBUF { PARAM_VALUE.ARRAY_N_WBUF } {
	# Procedure called to update ARRAY_N_WBUF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ARRAY_N_WBUF { PARAM_VALUE.ARRAY_N_WBUF } {
	# Procedure called to validate ARRAY_N_WBUF
	return true
}
...
proc update_PARAM_VALUE.TAG_BUF_ADDR_W_BBUF { PARAM_VALUE.TAG_BUF_ADDR_W_BBUF } {
	# Procedure called to update TAG_BUF_ADDR_W_BBUF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TAG_BUF_ADDR_W_BBUF { PARAM_VALUE.TAG_BUF_ADDR_W_BBUF } {
	# Procedure called to validate TAG_BUF_ADDR_W_BBUF
	return true
}

proc update_PARAM_VALUE.TAG_BUF_ADDR_W_IBUF { PARAM_VALUE.TAG_BUF_ADDR_W_IBUF } {
	# Procedure called to update TAG_BUF_ADDR_W_IBUF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TAG_BUF_ADDR_W_IBUF { PARAM_VALUE.TAG_BUF_ADDR_W_IBUF } {
	# Procedure called to validate TAG_BUF_ADDR_W_IBUF
	return true
}

proc update_PARAM_VALUE.TAG_BUF_ADDR_W_OBUF { PARAM_VALUE.TAG_BUF_ADDR_W_OBUF } {
	# Procedure called to update TAG_BUF_ADDR_W_OBUF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TAG_BUF_ADDR_W_OBUF { PARAM_VALUE.TAG_BUF_ADDR_W_OBUF } {
	# Procedure called to validate TAG_BUF_ADDR_W_OBUF
	return true
}

proc update_PARAM_VALUE.TAG_BUF_ADDR_W_WBUF { PARAM_VALUE.TAG_BUF_ADDR_W_WBUF } {
	# Procedure called to update TAG_BUF_ADDR_W_WBUF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TAG_BUF_ADDR_W_WBUF { PARAM_VALUE.TAG_BUF_ADDR_W_WBUF } {
	# Procedure called to validate TAG_BUF_ADDR_W_WBUF
	return true
}

proc update_PARAM_VALUE.TAG_W { PARAM_VALUE.TAG_W } {
	# Procedure called to update TAG_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TAG_W { PARAM_VALUE.TAG_W } {
	# Procedure called to validate TAG_W
	return true
}
...
proc update_PARAM_VALUE.WEIGHT_ROW_NUM { PARAM_VALUE.WEIGHT_ROW_NUM } {
	# Procedure called to update WEIGHT_ROW_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.WEIGHT_ROW_NUM { PARAM_VALUE.WEIGHT_ROW_NUM } {
	# Procedure called to validate WEIGHT_ROW_NUM
	return true
}
...
proc update_MODELPARAM_VALUE.TAG_W { MODELPARAM_VALUE.TAG_W PARAM_VALUE.TAG_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TAG_W}] ${MODELPARAM_VALUE.TAG_W}
}
...
proc update_MODELPARAM_VALUE.WEIGHT_ROW_NUM { MODELPARAM_VALUE.WEIGHT_ROW_NUM PARAM_VALUE.WEIGHT_ROW_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.WEIGHT_ROW_NUM}] ${MODELPARAM_VALUE.WEIGHT_ROW_NUM}
}
...
proc update_MODELPARAM_VALUE.TAG_BUF_ADDR_W_IBUF { MODELPARAM_VALUE.TAG_BUF_ADDR_W_IBUF PARAM_VALUE.TAG_BUF_ADDR_W_IBUF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TAG_BUF_ADDR_W_IBUF}] ${MODELPARAM_VALUE.TAG_BUF_ADDR_W_IBUF}
}

proc update_MODELPARAM_VALUE.TAG_BUF_ADDR_W_BBUF { MODELPARAM_VALUE.TAG_BUF_ADDR_W_BBUF PARAM_VALUE.TAG_BUF_ADDR_W_BBUF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TAG_BUF_ADDR_W_BBUF}] ${MODELPARAM_VALUE.TAG_BUF_ADDR_W_BBUF}
}

proc update_MODELPARAM_VALUE.TAG_BUF_ADDR_W_WBUF { MODELPARAM_VALUE.TAG_BUF_ADDR_W_WBUF PARAM_VALUE.TAG_BUF_ADDR_W_WBUF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TAG_BUF_ADDR_W_WBUF}] ${MODELPARAM_VALUE.TAG_BUF_ADDR_W_WBUF}
}

proc update_MODELPARAM_VALUE.TAG_BUF_ADDR_W_OBUF { MODELPARAM_VALUE.TAG_BUF_ADDR_W_OBUF PARAM_VALUE.TAG_BUF_ADDR_W_OBUF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TAG_BUF_ADDR_W_OBUF}] ${MODELPARAM_VALUE.TAG_BUF_ADDR_W_OBUF}
}

proc update_MODELPARAM_VALUE.ARRAY_N_WBUF { MODELPARAM_VALUE.ARRAY_N_WBUF PARAM_VALUE.ARRAY_N_WBUF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ARRAY_N_WBUF}] ${MODELPARAM_VALUE.ARRAY_N_WBUF}
}
